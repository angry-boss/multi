require 'spec_helper'
require 'multi/logic/host'

describe Multi::Logic::Host do
  ...
  describe "#parse_tenant_name" do
    ...
    context "assuming no ignored_first_subdomains" do
      ...
      context "with 3 parts" do
        it "should return the whole host" do
          ...
          expect(logic.parse_tenant_name(request)).to eq('foo.bar.com')
        end
      end
      ...
      context "with 6 parts" do
        it "should return the whole host" do
          ...
          expect(logic.parse_tenant_name(request)).to eq('one.two.three.foo.bar.com')
        end
      end
    end
    ...
    context "assuming ignored_first_subdomains is set" do
      ...
      context "with 3 parts" do
        it "should return host without www" do
          ...
          expect(logic.parse_tenant_name(request)).to eq('bar.com')
        end
      ...
      context "with 6 parts" do
        ...
        it "should return host without www" do
          ...
          expect(logic.parse_tenant_name(request)).to eq('one.two.three.bar.com')
        end
      end
    end
    ...
    context "assuming localhost" do
      it "should return localhost" do
        ...
        expect(logic.parse_tenant_name(request)).to eq('localhost')
      end
    end
    ...
    context "assuming ip address" do
      it "should return the ip address" do
        ...
        expect(logic.parse_tenant_name(request)).to eq('127.0.0.1')
      end
    end
  end
  ...
  describe "#call" do
    it "switches to the proper tenant" do
      ...
      expect(Multi::Tenant).to receive(:switch).with('foo.bar.com')
    ...
    it "ignores ignored_first_subdomains" do
      ...
      expect(Multi::Tenant).to receive(:switch).with('bar.com')
      logic.call('HTTP_HOST' => 'foo.bar.com')
    end
  end
end
