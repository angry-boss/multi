require 'multi/railtie' if defined?(Rails)
...
module Multi
  ...
  # Exceptions
  MultiError = Class.new(StandardError)

  # Raised when Multi cannot find the adapter specified in <tt>config/database.yml</tt>
